...
def main(argv: list[str] | None = None) -> int:
    ...
    write_json(args.output_json, {
        "evaluation_job_id": int(payload["evaluation_job"]["id"]),
        "blue_submission_id": int(blue_submission["id"]),
        "repo_full_name": str(claim_payload["github_repo_full_name"]),
        "pr_number": int(claim_payload["github_pr_number"]),
